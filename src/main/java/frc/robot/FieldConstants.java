...
public class FieldConstants {
  ...
  public static class Barge {
    public static final List<Pose2d> bargeLine =
        Arrays.asList(
            new Pose2d(
                fieldLength / 2 + Units.inchesToMeters(52), fieldWidth / 2, Rotation2d.kZero),
            new Pose2d(
                fieldLength / 2 - Units.inchesToMeters(52), fieldWidth / 2, Rotation2d.k180deg));
  ...
  public static boolean isAlgaeHigh(Pose2d currentPose) {
    return List.of(FieldConstants.Reef.centerFaces).indexOf(getNearestReefFace(currentPose)) % 2
        == 0;
  }
